            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className={`px-5 py-3 rounded-xl font-bold transition ${activeTab === "take"
                                ? "bg-indigo-600"
                                : "bg-slate-800"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-5 py-3 rounded-xl font-bold transition ${activeTab ===
                                "records"
                                ? "bg-indigo-600"
                                : "bg-slate-800"
                            }`}
                                    ...
                                    >
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className={`px-5 py-2 rounded-xl font-bold transition ${attendanceMap[
                                                        student.id
                                                    ] ===
                                                        "present"
                                                        ? "bg-emerald-600"
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            ...
                            <div className="flex flex-col md:flex-row gap-3">
                                ...
                                <select
                                    ...
                                    className="bg-slate-800 border border-slate-700 rounded-xl px-4 py-2 min-w-[220px]"
                                >
